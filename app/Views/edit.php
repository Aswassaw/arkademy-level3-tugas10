  ...
  <main class="my-4">
    <div class="container">
      ...
      <div class="card mx-auto" style="max-width: 600px;">
        <div class="card-body">
          <h1 class="card-title fs-2">Edit Produk</h1>
          <hr>
          <form action="<?= base_url('/update') ?>/<?= $produk["id"] ?>" method="post">
            ...
            <div class="mb-3">
              ...
              <textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control" required><?= $produk["keterangan"] ?></textarea>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="jumlah" id="jumlah" value="<?= $produk["jumlah"] ?>" class="form-control" required>
            </div>
